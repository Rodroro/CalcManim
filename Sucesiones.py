...
##grid para animaciones de definicion de limite de sucesiones y definicion de sucesiones
class Grid(VGroup):
    CONFIG = {
        "height": 6.0,
        "width": 6.0,
...
##sucesiones para animaciones de definicion de limite de sucesiones y definicion de sucesiones
